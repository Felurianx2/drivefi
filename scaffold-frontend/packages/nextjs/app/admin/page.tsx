...
export default function AdminPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    model: "",
    mileage: "",
    serviceHistory: "Full Dealer History",
    escrowDuration: "30",
    commissionFee: "2.5",
  ...
  const handleMint = () => {
    ...
    // TODO: Integrate with CarNFT smart contract
  };
      ...
      <main className="pt-24 pb-32 px-6 max-w-5xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <p className="text-xs text-primary mt-2 font-mono">
            Contract: 0xF22C4958D2276E8B3...SF25CdC9552278e5765
          </p>
        </section>
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-surface-container-lowest border border-white/10 rounded-lg px-4 py-3 text-on-surface focus:border-primary focus:ring-1 focus:ring-primary font-mono"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder="YYYY"
                      className="w-full bg-surface-container-lowest border border-white/10 rounded-lg px-4 py-3 text-on-surface focus:border-primary focus:ring-1 focus:ring-primary"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-label uppercase tracking-widest text-secondary mb-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder="0.00"
                      className="w-full bg-surface-container-lowest border border-white/10 rounded-lg px-4 py-3 text-on-surface focus:border-primary focus:ring-1 focus:ring-primary pr-20"
                    />
            ...
            <section className="glass-panel p-6 rounded-xl border border-white/5">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-surface-container-lowest rounded-lg border border-white/10">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      name="enableMultiSig"
                      checked={formData.enableMultiSig}
                      onChange={handleInputChange}
            ...
            <section className="glass-panel p-6 rounded-xl border border-white/5">
              ...
              <div className="border-2 border-dashed border-primary/30 rounded-xl p-8 text-center bg-primary/5">
                ...
                <button className="px-6 py-2 bg-primary/20 text-primary rounded-lg font-headline font-bold text-sm hover:bg-primary/30 transition-all">
                  Browse Files
                </button>
              </div>
            </section>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-xl border border-white/5 sticky top-24">
              <div className="mb-4">
                ...
                <div className="aspect-square bg-surface-container-lowest rounded-lg flex items-center justify-center mb-4">
                  {previewImage ? (
                    <img src={previewImage} alt="Vehicle preview" className="w-full h-full object-cover rounded-lg" />
                  ) : (
              ...
              <div className="space-y-3">
                <button
                  onClick={handleMint}
                  className="w-full py-3 rounded-xl bg-gradient-to-br from-primary to-on-primary-container text-on-primary font-headline font-bold hover:brightness-110 transition-all active:scale-95 flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-surface-container-highest text-on-surface font-headline font-bold hover:brightness-125 transition-all border border-white/10"
                >
                  {t("admin.saveDraft")}
                </button>
              </div>
              ...
              <p className="text-[10px] text-secondary text-center mt-4">
                <span className="material-symbols-outlined text-xs align-middle">verified</span> Administrator-only
                verified portal. Multi-sig approval required for asset audit.
              </p>
            </div>
          </div>
        </div>

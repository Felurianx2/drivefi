    ...
    <div className="min-h-screen bg-[#041329] text-on-surface font-body">
      ...
      <main className="pt-24 pb-32 px-6 max-w-7xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-surface-container-low p-8 rounded-xl flex flex-col justify-between min-h-[180px] border border-white/5">
          ...
          <div className="bg-surface-container-low p-8 rounded-xl relative overflow-hidden flex flex-col min-h-[180px] border border-white/5">
            <div className="z-10">
            ...
            <div className="absolute bottom-0 left-0 w-full h-24 opacity-40">
              <svg className="w-full h-full" viewBox="0 0 400 100">
                <path d="M0,80 Q50,70 100,50 T200,60 T300,20 T400,30" fill="none" stroke="#adc7ff" strokeWidth="3" />
                <path
                ...
                <defs>
                  <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" style={{ stopColor: "#adc7ff", stopOpacity: 0.2 }} />
                    <stop offset="100%" style={{ stopColor: "#adc7ff", stopOpacity: 0 }} />
                  </linearGradient>
                </defs>
              </svg>
            </div>
        ...
        <section className="glass-panel p-12 rounded-2xl border border-primary/20 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a href="/defi" className="px-6 py-3 rounded-xl bg-surface-container-highest text-on-surface font-headline font-bold hover:brightness-125 transition-all border border-white/10">
              Explore DeFi
            </a>
          </div>
        </section>
